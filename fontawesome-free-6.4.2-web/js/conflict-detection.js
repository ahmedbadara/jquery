...
/**
 * Sets up an event listener for the 'error' event on the contentWindow of the diagFrame.
 * Appends the diagScript and scriptUnderTest to the head of the contentDocument.
 *
 * @return {void}
 */
/**
